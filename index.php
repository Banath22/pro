...
<div class="wrapper">
	<h1>Image gallery</h1>
	<div class="navarrows">
	<div class="images"><img id="gallery1" class="image" src="img/img0.jpg"></div>
		<p id="text1">1/12</p>
	...
	<div class="navarrows">
	<div class="images"><img id="gallery2" class="image" src="img/img0.jpg"></div>
		<p id="text2">1/12</p>
	...
	<div class="navarrows">
	<div class="images"><img id="gallery3" class="image" src="img/img0.jpg"></div>
		<p id="text3">1/12</p>
